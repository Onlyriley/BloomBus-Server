...
function reapOldShuttles(dbRef, reapShuttleThresholdMilliseconds) {
    return __awaiter(this, void 0, void 0, function () {
        var now, cutoff, oldItemsQuery, snapshot, updates;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    now = Date.now();
                    cutoff = now - reapShuttleThresholdMilliseconds;
                    oldItemsQuery = dbRef.orderByChild("properties/timestamp").endAt(cutoff);
                    return [4 /*yield*/, oldItemsQuery.once("value")];
                case 1:
                    snapshot = _a.sent();
                    updates = {};
                    ...
                    return [2 /*return*/, dbRef.update(updates)];
            }
        });
    });
}
